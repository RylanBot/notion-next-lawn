...
export default function SideRight(props) {
  ...
  const LAWN_WIDGET_ANALYTICS = siteConfig(
    'LAWN_WIDGET_ANALYTICS',
    null,
    CONFIG
  )
  const LAWN_WIDGET_LATEST_POSTS = siteConfig(
    'LAWN_WIDGET_LATEST_POSTS',
    null,
    CONFIG
  )
    ...
    <>
      {hydrated && (
        <div id="sideRight" className="p-2 max-lg:mt-8">
          ...
          <div
            className={`lg:w-64 info-card ${activeTab !== 'info' && 'hidden'}`}
          >
            <InfoCard {...props} />
          ...
          <div
            className={`lg:w-64 sticky top-96 pl-8 pt-20 ${
