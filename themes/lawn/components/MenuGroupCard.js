...
const MenuGroupCard = (props) => {
  ...
  const links = [
    { name: locale.COMMON.ARTICLE, to: '/archive', slot: archiveSlot, show: siteConfig('LAWN_MENU_ARCHIVE', null, CONFIG) },
    { name: locale.COMMON.CATEGORY, to: '/category', slot: categorySlot, show: siteConfig('LAWN_MENU_CATEGORY', null, CONFIG) },
