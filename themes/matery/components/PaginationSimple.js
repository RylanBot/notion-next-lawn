    ...
    <div className="my-10 mx-6 flex justify-between font-medium text-black dark:text-gray-100 space-x-2">
      <Link
        ...
        <button
          rel="prev"
          className={`${
            currentPage === 1 ? 'opacity-20  bg-gray-200  text-gray-500 pointer-events-none ' : 'block text-white bg-teal-700'
      ...
      <Link
        ...
        <button
          rel="next"
          className={`${
            +showNext ? 'text-white bg-teal-700 ' : ' opacity-20 bg-gray-200 text-gray-500 pointer-events-none '
