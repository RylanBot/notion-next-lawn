...
const SocialButton = () => {
  ...
  return <div className='flex flex-col transform hover:scale-105 duration-200 text-white text-center bg-teal-700 rounded-full dark:bg-black cursor-pointer py-2.5'>
