...
export default function SlotBar(props) {
  ...
  if (tag) {
    return <div className="cursor-pointer px-3 py-2 mb-2 font-light hover:text-teal-700 dark:hover:text-teal-400 transform dark:text-white">
    ...
    return <div className="cursor-pointer text-lg px-5 py-1 mb-2 font-light hover:text-teal-700 dark:hover:text-teal-400 transform dark:text-white">
