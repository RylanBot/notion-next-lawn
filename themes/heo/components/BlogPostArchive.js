            ...
            <div className=''>
                ...
                <ul>
                    {posts?.map(post => {
                      ...
                      return <div key={post.id} className={'cursor-pointer flex flex-row mb-4 h-24 md:flex-row group w-full  dark:border-gray-600 hover:border-teal-500  dark:hover:border-yellow-600 duration-300 transition-colors justify-between overflow-hidden'}>
                                ...
                                <div>
                                    ...
                                    {post?.category && <div className={`flex items-center ${showPreview ? 'justify-center' : 'justify-start'} hidden md:block flex-wrap dark:text-gray-500 text-gray-600 `}>
                                        <Link passHref href={`/category/${post.category}`}
                                            className="cursor-pointer text-xs font-normal menu-link hover:text-teal-700  dark:text-gray-600 transform">
                                            {post.category}
                                        </Link>
                                    </div>}
                                    ...
                                    <Link
                                        ...
                                        passHref
                                        className={' group-hover:text-teal-700 group-hover:dark:text-teal-400 text-black dark:text-gray-100 dark:group-hover:text-yellow-600 line-clamp-2 replace cursor-pointer text-xl font-extrabold leading-tight'}>
