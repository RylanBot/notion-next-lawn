                ...
                {categoryOptions?.map(category => {
                  return (
                      <Link
                          ...
                          <div
                              className={
                                  ' duration-300 dark:hover:text-white dark:text-gray-200 rounded-2xl px-3 cursor-pointer py-1 hover:bg-teal-500 dark:hover:bg-yellow-600 hover:text-white'
                              }
                          >
