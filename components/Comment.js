    ...
    return (
      <>
        ...
        <div className="fixed inset-0 flex justify-center items-center z-50">
          {/* 闪烁动画 */}
          <div className="relative p-2 border-8 border-slate-200 rounded-full bg-white" style={{ width: '50vmin', height: '50vmin' }}>
            <img
              src="./favicon.png"
            ...
            />
            {/* 小圆形固定在大圆形的右下角 */}
            <div className="absolute bottom-0 right-0 mb-1 mr-1 md:mb-2 md:mr-2 lg:mb-4 lg:mr-4 h-10 w-10 md:h-12 md:w-12 lg:h-16 lg:w-16 bg-green-500 rounded-full border-4 border-slate-200"></div>
          </div>
        </div>
      </>
    )
