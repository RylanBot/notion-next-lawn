...
import { handleInternalUrls } from '@/libs/notion/mapPageUrl';
import { loadExternalResource } from '@/libs/common/utils';
...
const VConsole = dynamic(() => import('@/plugins/VConsole'), { ssr: false });
const AosAnimation = dynamic(() => import('@/plugins/AOSAnimation'), { ssr: false });

const ThemeSwitch = dynamic(() => import('@/plugins/ThemeSwitch'), { ssr: false });
const CustomContextMenu = dynamic(() => import('@/plugins/CustomContextMenu'), { ssr: false });
const DebugPanel = dynamic(() => import('@/plugins/DebugPanel'), { ssr: false });

const Analytics = dynamic(() => import('@vercel/analytics/react').then(async (m) => { return m.Analytics; }), { ssr: false });
const Gtag = dynamic(() => import('@/plugins/Gtag'), { ssr: false });
const Busuanzi = dynamic(() => import('@/plugins/Busuanzi'), { ssr: false });

const Fireworks = dynamic(() => import('@/plugins/Fireworks'), { ssr: false });
const FlutteringRibbon = dynamic(() => import('@/plugins/FlutteringRibbon'), { ssr: false });
const Ribbon = dynamic(() => import('@/plugins/Ribbon'), { ssr: false });
const MusicPlayer = dynamic(() => import('@/plugins/Player'), { ssr: false });
