...
function createNest() {
  ...
  function t() {
    (u = i.width = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth),
      (d = i.height = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight);
  }
  function o() {
    c.clearRect(0, 0, u, d);
    const e = [s].concat(x);
      ...
      for (
        ...
        (n = e[t]),
          o !== n &&
            ...
            (w = l * l + r * r),
            w < n.max &&
              (n === s && w >= n.max / 2 && ((o.x -= 0.03 * l), (o.y -= 0.03 * r)),
              (i = (n.max - w) / n.max),
              c.beginPath(),
              (c.lineWidth = i / 2),
  ...
  (i.style.cssText = 'position:fixed;top:0;left:0;pointer-events:none;z-index:' + a.z + ';opacity:' + a.o),
    (r = 'body'),
    e.appendChild(i),
    t(),
    (window.onresize = t),
