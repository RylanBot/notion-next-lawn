...
import { compressImage, mapImgUrl } from '@/libs/notion/mapImage';
import { mapPageUrl } from '@/libs/notion/mapPageUrl';
...
const CodePlugin = dynamic(() => import('@/plugins/CodePlugin'), {
  ssr: false
});

const Equation = dynamic(() =>
    import('@/plugins/Equation').then(async (m) => {
      return m.Equation;
    }),
  { ssr: false }
);
